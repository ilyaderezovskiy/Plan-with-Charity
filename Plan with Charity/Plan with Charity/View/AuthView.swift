...
//                    Text("Установите дедлайн и стоимость для своей задачи, и если не успеете выполнить её в срок, то можете перевести сумму “сгоревших” задач в выбранную  благотворительную организацию ")
//                        .opacity(0.5)
//                        .padding()
